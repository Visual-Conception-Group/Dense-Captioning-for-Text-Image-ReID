...
# dataset_address_prefix = "/raid/home/vibhu20150/Datasets/IIITD-20K-Dataset/"
...
def createJson(data, fileName, endTrainInx, endValInx):
  ...
  for i in data.keys():
    ...
    data_save = {
      ...
      'id': person_id,
      'processed_tokens': [tokens_1, tokens_2],
...
def main():
  ...
  createJson(data, "IIITD-20K-CUHK-FORMAT.json", 15000, 17500)
  return 
