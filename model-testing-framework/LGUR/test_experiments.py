...
if __name__ == '__main__':
    ...
    if opt.dataset == 'MSMT-PEDES':
        ...
        opt.class_num = 3102
        opt.vocab_size = 2500
        opt.dataroot = '../../Datasets/ICFG/ICFG_PEDES'
        ...
        opt.pkl_root = './processed_data_singledata_RSTP/'
        opt.class_num = 3701 
        opt.vocab_size = 3000
        opt.dataroot = '../../Datasets/RSTP/'
    elif opt.dataset == 'IIITD':
        # opt.pkl_root = '/home/Vibhu/git-stuff/Person-Re-ID/LGUR/processed_data_singledata_IIITD/'
        opt.pkl_root = './processed_data_singledata_IIITD/'
        opt.class_num = 15000 
        opt.vocab_size = 3373
        opt.dataroot = '../../IIITD-20K-Dataset/'
