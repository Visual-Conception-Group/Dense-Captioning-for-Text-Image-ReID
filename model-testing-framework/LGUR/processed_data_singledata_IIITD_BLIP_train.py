...
def parse_args():
    ...
    parser.add_argument('--json_root', default='./IIITD-BLIP-3-ICFG-FORMAT.json', type=str)
    # parser.add_argument('--out_root', default='./processed_data_singledata_IIITD', type=str) # processed_data_spa_img
    parser.add_argument('--out_root', default='./processed_data_singledata_IIITD_BLIP_3', type=str) # processed_data_spa_img
