...
def parse_args():
    ...
    parser.add_argument('--json_root', default='./ZURU-BLIP-5-ICFG-FORMAT.json', type=str)
    # parser.add_argument('--out_root', default='./processed_data_singledata_ZURU', type=str) # processed_data_spa_img
    parser.add_argument('--out_root', default='./processed_data_singledata_ZURU_BLIP_5', type=str) # processed_data_spa_img
