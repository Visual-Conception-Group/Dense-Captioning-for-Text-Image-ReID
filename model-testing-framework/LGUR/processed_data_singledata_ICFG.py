...
def parse_args():
    ...
    # parser.add_argument('--img_root', default='/home/Vibhu/LGUR/datasets/icfgpedes/ICFG_PEDES', type=str)
    parser.add_argument('--img_root', default='../../Datasets/ICFG/ICFG_PEDES', type=str)
    # parser.add_argument('--json_root', default='/home/Vibhu/LGUR/datasets/icfgpedes/ICFG-PEDES.json', type=str)
    parser.add_argument('--json_root', default='../../Datasets/ICFG/ICFG-PEDES.json', type=str)
...
def split_json(args):
    ...
    return train_json, test_json, entire_json
...
def main(args):
    train_json, test_json, entire_json = split_json(args)
