...
def parse_args():
    ...
    parser.add_argument('--json_root', default='./RL_Captions_ICFG-FORMAT_v2.json', type=str)
    # parser.add_argument('--out_root', default='./processed_data_singledata_IIITD', type=str) # processed_data_spa_img
    parser.add_argument('--out_root', default='./processed_data_singledata_IIITD_RL_v2', type=str) # processed_data_spa_img
