...
if __name__ == '__main__':
    ...
    for epoch in range(opt.start_epoch, opt.epoch):
        ...
        for times, [image, label, caption_code, caption_length, caption_mask] in enumerate(train_dataloader):
            ...
            loss, id_loss, id_loss_dict, ranking_loss, ranking_loss_dict, ranking_loss_dict_text, \
                ranking_loss_dict_image, pred_i2t_local, pred_t2i_local = compute_loss(image, label,\
                                                        caption_code, caption_length, caption_mask, network)
