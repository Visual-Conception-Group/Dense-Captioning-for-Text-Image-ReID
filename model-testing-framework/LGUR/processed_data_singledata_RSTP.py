...
def parse_args():
    ...
    parser.add_argument('--img_root', default='/raid/home/vibhu20150/Datasets/RSTP/imgs/', type=str)
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/RSTP/data_captions.json', type=str)
    parser.add_argument('--out_root', default='./processed_data_singledata_RSTP', type=str) # processed_data_spa_img
