...
def parse_args():
    ...
    parser.add_argument('--json_root', default='./combined_datasets.json', type=str)
    # parser.add_argument('--out_root', default='./processed_data_singledata_ZURU', type=str) # processed_data_spa_img
    parser.add_argument('--out_root', default='./processed_data_singledata_combined_datasets', type=str) # processed_data_spa_img
