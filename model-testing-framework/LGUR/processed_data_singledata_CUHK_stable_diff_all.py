...
def parse_args():
    ...
    parser.add_argument('--img_root', default='/raid/home/vibhu20150/Datasets/CUHK-PEDES/', type=str)
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/CUHK-PEDES/cuhk_stable_diff_reid_raw.json', type=str)
    parser.add_argument('--out_root', default='./processed_data_singledata_CUHK_stable_diff_all', type=str) # processed_data_spa_img
