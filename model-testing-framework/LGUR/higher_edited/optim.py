...
class DifferentiableOptimizer(_abc.ABC):
    def __init__(
        ...
        **kwargs
        ...
        # print("In higher optim",id(other)) #niranjan
        ...
        for group_idx, (group, orig_group) in enumerate(zipped):
            # print(group.shape, orig_group.shape)
            local_list = []
            # print(len(orig_group['params']))
    ...
    def step(
        ...
        **kwargs
        ...
        all_grads = _torch.autograd.grad(
            loss,
            grad_targets,
            create_graph=self._track_higher_grads, #niranjan_comment
            # create_graph=True, #niranjan_edit
            # retain_graph=True, #niranjan_edit
