...
class IIITD_B1_B2_45K_IDs(BaseDataset):
    dataset_dir = 'IIITD_BLIP_LDM'

    def __init__(self, root='', verbose=True):
        super(IIITD_B1_B2_45K_IDs, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = self.dataset_dir
        self.anno_path = op.join(self.dataset_dir, '/raid/home/vibhu20150/Datasets/IIITD-OUTPUTDELIVERY/JsonOutput/IIITD-B1-B2-45K-IDs-ICFG-FORMAT-RELATIVE-EDIT.json')
        ...
        if verbose:
            self.logger.info("=>  IIITD B1 B2 45K IDs Images and Captions are loaded")
