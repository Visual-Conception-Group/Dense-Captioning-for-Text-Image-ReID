...
class IIITD_175K(BaseDataset):
    dataset_dir = 'IIITD_17.5K'

    def __init__(self, root='', verbose=True):
        super(IIITD_175K, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = self.dataset_dir
        self.anno_path = op.join(self.dataset_dir, 'JsonOutput/ZURU-ICFG-FORMAT-TRAIN-17.5K-RELATIVE.json')
        ...
        if verbose:
            self.logger.info("=> IIITD_17.5K Images and Captions are loaded")
