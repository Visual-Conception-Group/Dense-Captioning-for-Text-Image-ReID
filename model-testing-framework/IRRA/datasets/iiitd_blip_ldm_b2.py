...
class IIITD_BLIP_LDM_B2(BaseDataset):
    dataset_dir = 'IIITD_BLIP_LDM'

    def __init__(self, root='', verbose=True):
        super(IIITD_BLIP_LDM_B2, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = self.dataset_dir
        self.anno_path = op.join(self.dataset_dir, '/raid/home/vibhu20150/Datasets/IIITD-OUTPUTDELIVERY/JsonOutput/IIITD-BLIP-5-ICFG-FORMAT-RELATIVE.json')
        ...
        if verbose:
            self.logger.info("=> IIITD_BLIP_LDM_B2 Images and Captions are loaded")
