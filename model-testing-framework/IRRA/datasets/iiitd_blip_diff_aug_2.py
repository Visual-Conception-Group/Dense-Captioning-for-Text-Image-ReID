...
class IIITD_BLIP_DIFF_AUG_2(BaseDataset):
    dataset_dir = 'IIITD_BLIP_DIFF'

    def __init__(self, root='', verbose=True):
        super(IIITD_BLIP_DIFF_AUG_2, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = self.dataset_dir
        self.anno_path = op.join(self.dataset_dir, '/raid/home/vibhu20150/Datasets/ZURU-IIITD-OUTPUTDELIVERY/JsonOutput/Sairam_ZURU-BLIP-5-ICFG-FORMAT-RELATIVE.json')
        ...
        if verbose:
            self.logger.info("=> IIITD_BLIP_DIFF_AUG_2 Images and Captions are loaded")
