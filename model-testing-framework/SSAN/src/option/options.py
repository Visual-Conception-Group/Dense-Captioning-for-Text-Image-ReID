...
class options():
    def __init__(self):
        ...
        self._par.add_argument('--GPU_id', type=str, default='5', help='choose GPU ID [0 1]')
        ...
        self._par.add_argument('--test_dataset', type=str, default='', help='choose the testing dataset ')
        self._par.add_argument('--test_train_dataset', type=str, default='', help='choose the train dataset for cross dataset testing')
        self._par.add_argument('--cross_dataset', type=bool, default=False, help='Whether cross-dataset testing or not')
