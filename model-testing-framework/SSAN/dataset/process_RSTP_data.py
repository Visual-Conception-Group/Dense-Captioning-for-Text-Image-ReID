...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/RSTP/data_captions.json', type=str)
    parser.add_argument('--out_root', default='/raid/home/vibhu20150/Person-Re-ID/SSAN/processed_data_RSTP', type=str)
...
def split_json(args):
    ...
    for data in reid_raw_data:
        data_save = {
            ...
            'id': data['id'],
            'tokens': [word_tokenize(i) for i in data['captions']],
...
def generate_test_val_caption_id(data_json, word2Ind, data_name, args):
    ...
    for data in data_json:
        ...
        for j in range(len(data['tokens'])):
            ...
            data_tokens_save.append(tokens_j)
