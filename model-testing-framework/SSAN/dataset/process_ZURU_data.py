...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/ZURU-IIITD-OUTPUTDELIVERY/JsonOutput/ZURU-ICFG-FORMAT.json', type=str)
    parser.add_argument('--out_root', default='/raid/home/vibhu20150/Person-Re-ID/SSAN/processed_data_ZURU', type=str)
