...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/ICFG/ICFG-PEDES-val.json', type=str)
    parser.add_argument('--out_root', default='/raid/home/vibhu20150/Person-Re-ID/SSAN/processed_data_ICFG-PEDES-val', type=str)
...
def generate_test_val_caption_id(data_json, word2Ind, data_name, args):
    ...
    for data in data_json:
        ...
        data_tokens_save.append(data['tokens'])
...
def main(args):
    train_json, val_json, test_json = split_json(args)
    word2Ind = build_vocabulary(train_json, args)

    train_save = generate_captionid(train_json, word2Ind, 'train', args)
    val_save = generate_test_val_caption_id(val_json, word2Ind, 'val', args)
    ...
    save_dict(word2Ind, os.path.join(args.out_root, 'word2Ind'))
