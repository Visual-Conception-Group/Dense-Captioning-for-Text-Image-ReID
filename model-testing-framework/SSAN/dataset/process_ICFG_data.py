...
def parse_args():
    ...
    parser.add_argument('--json_root', default='/raid/home/vibhu20150/Datasets/ICFG/ICFG-PEDES.json', type=str)
    parser.add_argument('--out_root', default='/raid/home/vibhu20150/Person-Re-ID/SSAN/processed_data_ICFG-PEDES', type=str)
